  ...
  return (
    <div className="flex h-screen print:block print:h-auto">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex h-[58px] shrink-0 items-center gap-2.5 border-b border-line bg-surface px-4 print:hidden">
          <button
            onClick={() => setMenuAberto((v) => !v)}
            aria-label="Abrir menu"
            className="grid h-[30px] w-[30px] shrink-0 place-items-center rounded-sm text-graphite hover:bg-line-soft hover:text-ink md:hidden"
          >
            <Menu className="h-4 w-4" strokeWidth={1.6} />
          </button>

          <button className="flex h-8 min-w-0 max-w-[420px] flex-1 items-center gap-2 rounded-sm border border-line bg-raise px-2.5 text-[12.5px] text-muted hover:border-graphite">
          ...
          <button
            ...
            className="grid h-[30px] w-[30px] shrink-0 place-items-center rounded-sm text-graphite hover:bg-line-soft hover:text-ink"
          >
            {escuro ? <Sun className="h-4 w-4" strokeWidth={1.6} /> : <Moon className="h-4 w-4" strokeWidth={1.6} />}
          </button>

          <button aria-label="Notificações" className="grid h-[30px] w-[30px] shrink-0 place-items-center rounded-sm text-graphite hover:bg-line-soft hover:text-ink">
            <Bell className="h-4 w-4" strokeWidth={1.6} />
          </button>

          <div className="ml-1 flex shrink-0 items-center gap-2.5 border-l border-line-soft pl-3">
